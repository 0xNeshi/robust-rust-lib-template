...
Please use the following link to submit your vulnerability: [Report a vulnerability](https://github.com/openzeppelin/rust-project-template/security/advisories/new)
